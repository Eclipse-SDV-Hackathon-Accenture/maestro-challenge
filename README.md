...
The in-vehicle-stack is started with Eclipse Chariott, Ibeji, Agemo, Freyja, and an Eclipse Mosquitto MQTT broker inside of the orchestrator environments. 
...
1. Push it to a container registry.
...
- Extend the smart trailer application to adjust some body control functions or powertrain, based on the weight of the trailer to ensure a smooth trip.
